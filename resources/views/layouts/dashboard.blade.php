            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="/dashboard" class="nav-link @if ($title == 'SIADU &mdash; Dashboard') active @endif">
                        ...
                        <li class="nav-item @if (
                            $title == 'SIADU &mdash; Laporan' ||
                                'SIADU &mdash; Buat Laporan' ||
                                'SIADU &mdash; Masyarakat' ||
                                'SIADU &mdash; Petugas') menu-open @endif"">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="/dashboard/report"
                                        class="nav-link @if ($title == 'SIADU &mdash; Laporan' || 'SIADU &mdash; Buat Laporan') active @endif">
