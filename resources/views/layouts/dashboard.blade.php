                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="/dashboard/report" class="nav-link @if ($title === 'SIADU &mdash; Laporan' &&  'SIADU &mdash; Buat Laporan') active @else @endif">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Data Laporan</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="/dashboard/masyarakat" class="nav-link @if ($title === 'SIADU &mdash; Masyarakat' &&  'SIADU &mdash; Edit Masyarakat') active @else  @endif">
                                        <i class="far fa-circle nav-icon"></i>
