                ...
                <form action="/register" method="post">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" class="form-control @error('name') is-invalid @enderror" name="name"
                            required value="{{ old('name') }}" placeholder="Full name">
                    ...
                    <input type="hidden" name="role" value="m" id="">
                    <div class="input-group mb-3">
                        <input type="text" class="form-control @error('nik') is-invalid @enderror" name="nik"
                            required value="{{ old('nik') }}" placeholder="NIK">
                        <div class="input-group-append">
                            <div class="input-group-text">
                    ...
                    <div class="input-group mb-3">
                        <input type="tel" class="form-control @error('telp') is-invalid @enderror" name="telp"
                            required value="{{ old('telp') }}" placeholder="Telphone">
                        <div class="input-group-append">
                            <div class="input-group-text">
